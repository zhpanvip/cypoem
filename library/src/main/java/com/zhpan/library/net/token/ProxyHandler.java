...
package com.zhpan.library.net.token;

import android.text.TextUtils;

import com.zhpan.library.module.BasicRequest;
import com.zhpan.library.net.common.CommonService;
import com.zhpan.library.net.common.DefaultObserver;
import com.zhpan.library.net.common.NetConstants;
import com.zhpan.library.net.common.RetrofitService;
    ...
    private Observable<?> refreshTokenWhenTokenInvalid() {
        synchronized (ProxyHandler.class) {
            ...
            if (new Date().getTime() - tokenChangedTime < REFRESH_TOKEN_VALID_TIME) {
                ...
                RetrofitService
                        .getRetrofitBuilder(NetConstants.API_SERVER_URL)
                        .build()
                    ...
                    for (Annotation annotation : annotations) {
                        if (annotation instanceof FieldMap || annotation instanceof QueryMap) {
                            ...
                            if (args[i] instanceof BasicRequest) {
                                BasicRequest requestData = (BasicRequest) args[i];
