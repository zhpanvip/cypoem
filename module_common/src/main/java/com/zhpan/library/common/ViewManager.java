...
//    private static List<BaseVcFragment> fragmentList;

    private static SparseArray<BaseVcFragment> fragmentList;
    ...
    public void addFragment(int index, BaseVcFragment fragment) {
    ...
    public BaseVcFragment getFragment(int index) {
        if (fragmentList != null) {
    ...
    public SparseArray<BaseVcFragment> getAllFragment() {
        if (fragmentList != null) {
            return fragmentList;
        }
        return null;
